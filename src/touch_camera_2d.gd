...
extends Camera2D
# https://raw.githubusercontent.com/williambcosta/godot-touch-camera-2d/d64e0cb6fca8d21f6a3375dac7f2316eac63f22e/TouchCamera2D.gd
...
@export_range(0.00, 1, 0.01) var return_speed: float = 0.15
